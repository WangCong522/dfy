            ...
            <form class="form-horizontal" role="form" method="post" action="index.php?act=fin&op=DoHk">
                <div class="form-body">
                    <div class="form-group">
                        <label class="col-md-3 control-label new_style_padding1 col-xs-3 text_new_style_r ">汇款方式</label>
                    ...
                    <div class="form-group bank" style="display: ;">
                        <label class="col-md-3 control-label new_style_padding1 col-xs-3 text_new_style_r ">银行名称</label>
                    ...
                    <div class="form-group bank_zh">
                        <label class="col-md-3 control-label new_style_padding1 col-xs-3 text_new_style_r ">收款账号</label>
                        <div class="col-md-9 col-xs-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label new_style_padding1 col-xs-3 text_new_style_r ">汇款账号</label>
                        <div class="col-md-9 col-xs-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label new_style_padding1 col-xs-3 text_new_style_r ">账户名:</label>
                        <div class="col-md-9 col-xs-8">
                            <input type="text" class="form-control zhm" required name="zhm" placeholder="汇款开户名">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label new_style_padding1 col-xs-3 text_new_style_r ">汇款金额</label>
                        <div class="col-md-9 col-xs-8">
                            <input type="text" class="form-control jine" required name="jine" placeholder="汇款金额">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label new_style_padding1 col-xs-3 text_new_style_r ">时间</label>
                        <div class="col-md-9 col-xs-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label new_style_padding1 col-xs-3 text_new_style_r ">手机</label>
                        <div class="col-md-9 col-xs-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label new_style_padding1 col-xs-3 text_new_style_r ">充值描述</label>
                        <div class="col-md-9 col-xs-8">
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9 col-xs-12 text-center">
