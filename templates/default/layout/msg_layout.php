...
#faq { display: none;}
.msg { font: 100 36px/48px arial,"microsoft yahei"; color: #555; background-color: #FFF; text-align: center; width: 98%; border: solid 1px #E6E6E6; margin-bottom: 10px; padding: 180px 0;  margin:0 auto; position:absolute; top:10%; left:1%;}
