        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <strong>
                        <?php
                        foreach ( $output['groupList'] as $key => $value) {
                            if ($value['group_id'] == $output['userGroudMsg']['groud_id']){
                                echo $value['name'];
                            } 
                        }
                     ?></strong></dd>
                     <input type="hidden" name="groud_id" value="<?php echo$output['userGroudMsg']['groud_id'] ?>"/>
            </dl>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="number" id="rate" name="rate" class="input-number" value="<?php echo $output['userGroudMsg']['rate'] ?>" required>
                    <span class="err"></span>
                </dd>
            </dl>
