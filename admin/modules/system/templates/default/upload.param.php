...
<!--            <dl class="row">-->
<!--                <dt class="tit">-->
<!--                    <label for="article_title">星级升级(根据左右单数)</label>-->
<!--                </dt>-->
<!--                <dd class="opt">-->
...
<!--            <dl class="row">-->
<!--                <dt class="tit">-->
<!--                    <label for="article_title">星级升级(根据PV)</label>-->
<!--                </dt>-->
<!--                <dd class="opt">-->
<!--                    <table class="gridtable">-->
<!--                        <tr>-->
...
<!--                        </tr>-->
<!--                        --><?php //foreach ($output['list_setting']['con_pv'] as $key => $value) { ?>
<!--                            <tr>-->
<!--                                <td>-->
<!--                                    --><?php //if($key <= 7):?>
<!--                                        --><?php //echo $key ?><!--星-->
